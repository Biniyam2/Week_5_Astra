...
{
    public partial class IntialMoveShop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostUrl = table.Column<string>(type: "nvarchar(2084)", maxLength: 2084, nullable: true),
                    BackdropUrl = table.Column<string>(type: "nvarchar(2084)", maxLength: 2084, nullable: true),
                    OriginalLanguage = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TowFactorEnabled = table.Column<byte>(type: "tinyint", nullable: false),
                    LockoutEndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastLodinDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
